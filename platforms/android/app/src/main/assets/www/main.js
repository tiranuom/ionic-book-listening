...
var map = {
	"./book-details/book-details.module": [
...
/* harmony import */ var _book_api_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./book-api.service */ "./src/app/book-api.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            entryComponents: [],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"], _angular_http__WEBPACK_IMPORTED_MODULE_9__["HttpModule"]],
            providers: [
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_5__["StatusBar"],
                _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_4__["SplashScreen"],
                _book_api_service__WEBPACK_IMPORTED_MODULE_8__["BookApiService"],
...
var BookApiService = /** @class */ (function () {
    function BookApiService(http) {
        this.http = http;
        console.log("Book Api Service Started");
    }
    BookApiService.prototype.getData = function (keyword) {
        var _this = this;
        var responseObservable = this.http.get("http://openlibrary.org/subjects/" + keyword + ".json");
        responseObservable.subscribe(function (data) { return _this.data = data.json(); });
        return responseObservable;
    };
    BookApiService.prototype.getBook = function (id) {
        return this.data && this.data.works.find(function (_a) {
            var cover_id = _a.cover_id;
            return id == cover_id;
        }) || null;
    };
    BookApiService = __decorate([
...
module.exports = __webpack_require__(/*! /home/tiran/projects/msc-ucsc/ionic-book-listing/src/main.ts */"./src/main.ts");
